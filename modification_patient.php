...
<body>
            ...
            <div class="card p-9">
                <div class="row justify-content-center">
                    <div class="col-12">
                        ...
                        <h4 class="errormessage text-center"></h4>
                    </div>
                </div>
                <form class="form-card" method="post" action="modification_patient.php">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <div class="col-12">
                                <input type="submit" name="modifier_patient" value="Valider les modifications" class="btn-modifier">
                            </div>
                        </div>
                    </div>
                </form>
    ...
    if (isset($_POST['boutonModification']) && $_POST['boutonModification'] == 'Valider les modifications' ) {
        ...
        if ($reqModification === false) {
            ...
            if($reqModification->execute() === false) {
